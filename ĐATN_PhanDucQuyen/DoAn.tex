...
\usepackage{booktabs} % Đường kẻ bảng chuyên nghiệp
...
% Cho bảng glossary chiếm toàn bộ chiều rộng trang
\renewcommand{\glossarypreamble}{%
  \setlength{\LTleft}{0pt}%
  \setlength{\LTright}{0pt}%
}

% Cột "Ý nghĩa" tự giãn hết phần còn lại
\renewcommand{\glsdescwidth}{\dimexpr\linewidth-4cm\relax}
% ============================================
\usepackage{setspace}
\usepackage{parskip}
...
\def \TITLE{Hệ thống quản lý và tiện ích ký túc xá cho sinh viên tích hợp phân bổ phòng tự động và trực quan hóa không gian}
\def \AUTHOR{PHAN ĐỨC QUYỀN}
...
% Không stretch khoảng trắng dọc để fill trang
\raggedbottom
