...
giản --- chủ yếu là số hoá những gì đang làm thủ công. Rồi tôi gặp cán bộ
đang dùng ba file Excel ghép lại để chạy một đợt phân bổ, gặp sinh viên từ
Nghệ An đăng ký phòng chỉ dựa trên mô tả văn bản vì không có cách nào xem
trước, gặp câu hỏi ``năm sau muốn tăng quota thì làm thế nào?'' mà nếu logic
hard-coded thì câu trả lời sẽ mất cả tuần. Mỗi cuộc gặp đó là một lần tôi
nhận ra mình đã hiểu sai độ phức tạp của vấn đề.
...
phức tạp, mà vì mỗi cái đến từ một lần tôi thực sự hiểu ra vấn đề. Quyết định
đầu tiên là đưa sandbox vào lõi nghiệp vụ như một lớp bắt buộc: tôi đã thử
thiết kế theo hướng ``chạy thật rồi undo nếu cần'' và nhận ra ngay điều đó không
tồn tại trong thực tế --- một khi email đã gửi đến 500 sinh viên, không có thao
tác kỹ thuật nào thu hồi được kỳ vọng đã hình thành. Quyết định thứ hai là
tách hoàn toàn cấu hình chính sách khỏi mã nguồn --- không phải để code sạch
hơn, mà là để trao quyền thay đổi cho đúng người: cán bộ vận hành, không phải
lập trình viên. Quyết định thứ ba là kiên trì với 3D visualization khi file
200~MB tưởng như không có lối ra --- nếu lúc đó bỏ cuộc, sinh viên từ tỉnh xa
vẫn sẽ chỉ có mô tả văn bản để đăng ký phòng.
